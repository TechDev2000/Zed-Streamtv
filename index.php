...
<body>
    <div class="w3-content" style="max-width: 1500px">
        <header class="w3-panel w3-center w3-opacity" style="padding: 10px 0; background-color: #d32f2f; color: #fff;">
            <a href="https://github.com/yourusername/crichd-streaming">
                <img src="./assets/logo.png" style="height: 90px" alt="CricHD Logo">
            </a>
        </header>

        <div class="container">
            <h1 class="page-title">Live Sports Streaming</h1>
            ...
            <div class="channel-grid">
                ...
                <!-- TNT Sports -->
                <div class="channel-box">
                    <a href="./stream/plays.html?max=../api-discovery/Animal_Planet.m3u8">
